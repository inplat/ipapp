...
APP_AMQP_URL=amqp://guest:guest@localhost:9004/ APP_AMQP_RPC_QUEUE=rpcqueue APP_LOG_ZIPKIN_ENABLED=1 APP_LOG_ZIPKIN_ADDR=http://127.0.0.1:9002/api/v2/spans APP_LOG_ZIPKIN_NAME=client python -m examples.amqp_rpc_client --log-level CRITICAL
